...
test.describe('Landing Page', () => {
  ...
  test.describe('Hero Section', () => {
    test('should display hero section with typewriter animation', async ({ page }) => {
    ...
    test('should have accessible hero content', async ({ page }) => {
      ...
      await expect(page.locator('text=Transform YouTube videos into searchable, interactive transcripts')).toBeVisible()
    })
  })
  ...
  test.describe('Navigation', () => {
    ...
    test('should navigate to transcribe page from Get Started button', async ({ page }) => {
      const getStartedButton = page.getByRole('link', { name: 'Get Started' }).first()
